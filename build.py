...
window.MGB_VERSION = {{ label: "2026-09-17z", note: "Live Report PDF now matches the full page: budget health, bills due, fund activity, reconciliation, bookkeeper footer" }};
