 ...
 */
export declare function Card({ className, children, ...rest }: CardProps): React.JSX.Element;
...
export declare function CardTitle({ className, children, ...rest }: CardTitleProps): React.JSX.Element;
...
export declare function CardSubtitle({ className, children, ...rest }: CardSubtitleProps): React.JSX.Element;
